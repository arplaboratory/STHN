...
# bing + thermal_123456
python global_pipeline/h5_merger.py --database_name satellite --database_indexes 0 --queries_name thermalmapping --queries_indexes 135 --compress --region_num 2 --generate_data database --resize_width 1024

python global_pipeline/h5_merger.py --database_name satellite --database_indexes 0 --queries_name thermalmapping --queries_indexes 024 --compress --region_num 1 --generate_data database --resize_width 1024
